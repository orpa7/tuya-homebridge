...
class BaseAccessory {
  constructor(platform, homebridgeAccessory, deviceConfig, categoryType, serviceType, subServices = [], hasBatteryService = false) {
    ...
    if (hasBatteryService) {
      this.battery = this.homebridgeAccessory.getService(Service.Battery);
      if (this.battery) {
        this.battery.setCharacteristic(Characteristic.Name, this.deviceConfig.name + ' Battery');
      }
      else {
        this.battery = this.homebridgeAccessory.addService(Service.Battery, this.deviceConfig.name + ' Battery');
      }
    }
